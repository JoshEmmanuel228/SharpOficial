...
# Buscar el producto "Cinturón Dr. Martens Mono Black con Costuras Negras" (ID 25)
for product in products:
    if product['id'] == 25 and "Mono Black" in product['name']:
        # Agregar el modelUrl
        product['modelUrl'] = '/models/cintonegro.glb'
