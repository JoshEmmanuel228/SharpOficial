...
# Buscar el producto "Cinturón Dr. Martens Black & White Stitch" (ID 24)
for product in products:
    if product['id'] == 24 and "White Stitch" in product['name']:
        # Agregar el modelUrl
        product['modelUrl'] = '/models/cintocosblan.glb'
