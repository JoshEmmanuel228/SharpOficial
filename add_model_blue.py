...
# Buscar el producto "Cinturón Dr. Martens Color Vibrante y Contraste Icónico" (ID 22)
for product in products:
    if product['id'] == 22 and "Color Vibrante" in product['name']:
        # Agregar el modelUrl
        product['modelUrl'] = '/models/cintoazu.glb'
